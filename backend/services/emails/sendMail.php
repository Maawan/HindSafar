<?php
function sendHotelMail($email,$htmlBody,$name , $pdfBinary , $fileName) {
    

    // You can now send this HTML with PHPMailer or Mailtrap API.
    sendMail($email , $htmlBody , $name, "Payment Confirmation | Hindsafar" , $pdfBinary , $fileName);
}
...
function sendMail($mailTo , $html , $name , $subject , $pdfBinary , $fileName) {
